...
public class Ilsik extends AppCompatActivity {

    private static final String LOG_TAG =  "ilsik";
    private static final String SHOW_LIST_STORE_URL =  Const.ILSIK;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_ilsik);
