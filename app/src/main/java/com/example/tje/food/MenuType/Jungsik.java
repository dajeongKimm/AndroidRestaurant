...
public class Jungsik extends AppCompatActivity {
    ...
    private static final String LOG_TAG =  "jungsik";
    private static final String SHOW_LIST_STORE_URL =  Const.JUNGSIK;
    ...
    public void init(){
        ...
        new AsyncTask<String,Void,String>(){
            ...
            protected void onPostExecute(String s) {
                ...
                //1. 리사이클러뷰 화면 연결
                recyclerView = (RecyclerView) findViewById(R.id.jungsikList);
                //2. 아답터 생성
